...
#define CLASSNAME_VISION_DET_RET "com/syx/dlib/VisionDetRet"
#define CONSTSIG_VISION_DET_RET "()V"

#define CLASSNAME_FACE_DET "com/syx/dlib/FaceDet"
#define CLASSNAME_PEDESTRIAN_DET "com/syx/dlib/PedestrianDet"
 ...
 public:
  JNI_VisionDetRet(JNIEnv* env) {
    ...
    jMethodID_addLandmark =
      ...
      // add by simon at 2017/05/01
    jMethodID_addPosePoint =
          env->GetMethodID(detRetClass, "addPosePoint", "(II)Z");
  ...
  void addLandmark(JNIEnv* env, jobject& jDetRet, const int& x, const int& y) {
    ...
    // add by simon at 2017/05/01
    void addPosePoint(JNIEnv* env, jobject& jDetRet, const int& x, const int& y) {
        env->CallBooleanMethod(jDetRet, jMethodID_addPosePoint, x, y);
    }

    // add by simon at 2017/05/04
    void addRotate(JNIEnv* env, jobject& jDetRet, const float& r) {
